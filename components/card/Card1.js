        ...
        <div className=" p-5 ">
          ...
          <div className="text-sm font-sans text-gray-300 mt-1">
            <p className="text-justify">
              The chat application is built on React on the client side, NestJS and MongoDB on the backend side. It has features like authentication,
              group chat, video and audio call. It uses WebRTC and socket.io to facilitates the communication. It is pet project that I use with
              friends and currently hosted on{' '}
