export default function Card({}) {
  return (
    <>
      {/* <div
        className={`bg-[url('/rgr.png')] bg-cover w-[80vw] h-[25vh] md:w-[30vw] shadow-rb `}
      > */}
      <div className="group bg-[url('/rgr.png')] bg-cover bg-mynavy bg-blend-overlay text-mylight w-[70vw] h-[30%] md:h-[30vh] md:w-[40vw] lg:w-[35vw]  opacity-90 shadow-rb flex flex-col justify-center cursor-pointer rounded-sm overflow-hidden">
        <div className=" p-5 ">
          <h6 className=" text-xs font-light text-teal-500">
            Featured Project
          </h6>
          <h5 className=" font-sans font-medium text-mylight group-hover:text-teal-500">
          ...
          <div className="text-sm font-sans text-gray-300 mt-1">
            <p className="text-justify">
              ...
              global search with Algolia. Building a custom multisite compatible
              WordPress plugin to build global search with Algolia.Building a
              custom multisite compatible WordPress plugin.
            </p>
            <p className="mt-2 text-[.55rem] text-gray-500">
              <code>Javascript NextJs</code>
            </p>
